                ...
                <div id="contents">
                    ...
                    <div id="content_form">
                        ...
                        <div id="id_div_form_buscar">
                            <form id="id_form_buscar_proveedor" class="form-style">
                                <table width="100%" >
                                    <tr>
                            ...
                            <div id="id_result_busqueda_proveedor" align="center" style="overflow-y:auto; "></div>
                        </div>
                            ...
                            <form id="id_registrar_proveedor" class="form-style">
                                <table width="100%">
                                    ...
                                    <tr>
                                        <td>NIT (*):</td>
                                        <td>
                                            <input type="text" id="id_txt_nit_proveedor" name="txt_nit_proveedor">
                                        </td>
                                        <td></td>
                                    </tr>
                                    <tr>
