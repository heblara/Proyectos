...
<html>
  ...
  <form  method="post" action="GuardarEntrada.php" name="form1" id="form1">	
    <table align="center">
      <tr valign="baseline">
        <td nowrap="nowrap" align="right"><p>Specific::(*)</p>
          <p>&nbsp;</p></td>
        <td>
      ...
      <tr valign="baseline">
        <td nowrap="nowrap" align="right"><p>Date of Purchase:(*)</p>
          <p>&nbsp;</p></td>
        <td>
          <input name="FechaCompra" class="fecha" type="text" placeholder="dd/mm/aaaa" size="32" required />

      <tr valign="baseline">
        <td nowrap="nowrap" align="right"><p>Amount:(*)</p>
        <p>&nbsp;</p></td>
        <td><input name="Cantidad" type="number" size="32" required />        </tr>
      <tr valign="baseline">
        <td nowrap="nowrap" align="right"><p>Value:</p>
          <p>&nbsp;</p></td>
...
<tr valign="baseline">
        <td nowrap="nowrap" align="right"><p>Maximum stock:(*)</p>
          <p>&nbsp;</p></td>
        <td>
