...
<html>
  ...
  <form  method="post" action="Save.php" name="form1" id="form1">	
    <table align="center">
      ...
      <tr valign="baseline">
        <td nowrap="nowrap" align="right"><p>Passport:(*)</p>
        <p>&nbsp;</p></td>
        <td>
          <input type="text" name="Pasaporte" value="" size="32" required />
        </tr>
      <tr valign="baseline">
        <td nowrap="nowrap" align="right"><p>Nationality:(*)</p>
        <p>&nbsp;</p></td>
        <td>
      ...
      <tr valign="baseline">
        <td nowrap="nowrap" align="right"><p>Monthly Income:(*)</p>
        <p>&nbsp;</p></td>
        <td>
