                        ...
                        <form id="id_registrar_usuario" class="form-style">
                            <table width="100%">
                                <tr>
                                    ...
                                    <td width="45%">
                                        <input type="hidden" id="id_hidden_cod_empleado" name="id_hidden_cod_empleado">
                                ...
                                <tr>
                                    <td>Estado Activo:</td>
                                    <td>
                                        <input type="checkbox" id="id_ckd_estado_usuario" name="id_ckd_estado_usuario" checked="true">
                                    </td>
                                    <td></td>
                                </tr>
                                <tr>
                                    <td></td>
                                    <td align="right">                                        
                                        <input type="button" id="id_btn_update_usuario" name="btn_update_usuario" value="Guardar">
                                        <input type="button" id="id_btn_delete_usuario" name="btn_delete_usuario" value="Eliminar">
                                        <input type="reset" id="id_btn_lean_usuario" name="btn_clean_usaurio" value="Limpiar">
                                    </td>
                                    <td></td>
                                </tr>
                            </table>                        
