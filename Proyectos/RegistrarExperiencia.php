                            ...
                            <form id="id_registrar_experiencia" class="form-style">
                                <table width="100%">
                                    ...
                                    <tr>
                                        <td></td>
                                        <td align="right">                                        
                                            <input type="button" id="id_btn_add_experiencia" name="btn_add_experiencia" value="Agregar">
                                            <input type="button" id="id_btn_update_experiencia" name="btn_update_experiencia" value="Modificar" style="display: none">
                                            <input type="button" id="id_btn_delete_experiencia" name="btn_delete_experiencia" value="Eliminar" style="display: none">
                                            <input type="button" id="id_btn_clean_experiencia" name="btn_clean_experiencia" value="Limpiar">
                                            <input type="button" id="id_btn_cancel_experiencia" name="btn_cancel_experiencia" value="Cancelar" style="display: none">
                                        </td>
                                        <td></td>
                                    </tr>
                                    <tr>
